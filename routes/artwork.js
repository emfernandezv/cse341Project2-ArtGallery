...
router.post('/',isAuthenticated, validator.artworkValidationRules(),validator.validate, artworkController.createArtwork);
router.put('/:id',isAuthenticated,validator.artworkValidationRules(),validator.validate, artworkController.updateArtwork);
